...
define( "RECIPIENT_NAME", "Doordasht Venture" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "hello@doordasht.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Startup question" ); //UPDATE THIS TO YOUR SUBJECT
